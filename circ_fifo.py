class CircularBufferList:
  ...
  - Большой незаполненный буфер может занимать память.
  - Любой сдвиг элементов потребует O(n) времени.
  """
...
'''
В общем случае, `collections.deque` будет быстрее, особенно в случаях,
когда предполагается частая вставка и удаление элементов.
